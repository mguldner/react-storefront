...
export function HomePage() {
  return (
    <div>
      <div className="bg-transparent h-[80vh] flex items-center justify-center">
        <div>
          <p className="text-white text-8xl sm:text-xxl font-display text-center animate-text-pop-up-top-3">
            Psyaïeaïe
          </p>
          <p className="text-white text-7xl sm:text-9xl font-display text-center">
